...
const Admin = () => {
    ...
    const handleAddProduct = async (e) => {
        ...
        try {
            ...
            setAdminError(err.message || 'Failed to add product.');
        } finally {
            setAdminBusy(false);
        }
    };
                    ...
                    <div className="bg-gray-700 p-6 rounded-lg lg:col-span-1">
                        ...
                        <form onSubmit={handleAddProduct} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                disabled={adminBusy}
                                className="w-full bg-amber-500 hover:bg-amber-600 disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-bold py-2 rounded flex items-center justify-center gap-2"
                            >
                                <Plus size={18} /> {adminBusy ? 'Saving...' : 'Add Product'}
                            </button>
                            {adminError && (
