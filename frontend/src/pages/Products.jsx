    ...
    const filteredProducts = visibleProducts
        ...
        .sort((a, b) => {
            ...
            switch (sortOption) {
                ...
                case 'likes':
                    return (bAnalytics.likes || 0) - (aAnalytics.likes || 0);
                case 'rating':
                ...
                case 'trending':
                default: {
                    const aScore = (aAnalytics.views || 0) + (aAnalytics.unitsSold || 0) * 5;
                    const bScore = (bAnalytics.views || 0) + (bAnalytics.unitsSold || 0) * 5;
    ...
    return (
        <div id="products" className="page active">
            ...
            <div className="container mx-auto px-6 py-12">
                ...
                {productsLoading ? (
                    <p className="text-center text-gray-400 mt-8 py-12">Loading products...</p>
                ) : productsError ? (
                    <p className="text-center text-red-400 mt-8 py-12">
