        ...
        <div id="about" className="page active">
            <div className="bg-gray-800 py-12">
                <div className="container mx-auto px-6 text-center">
                    <h1 className="text-4xl font-bold text-white">About Printed Dimensions</h1>
            ...
            <div className="container mx-auto px-6 py-20">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mb-4">Printed Dimensions was born from a shared passion for innovation and design. We saw the incredible potential of 3D printing to create not just prototypes, but beautiful, functional, and personalized objects.</p>
