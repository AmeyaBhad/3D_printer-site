...
public class Product {
    ...
    public Product(Long id, String name, String description, Double price, String category, String image, Integer stock, ProductAnalytics analytics, Boolean isArchived) {
        this.id = id;
        this.name = name;
